    ...
    <section className=" bg-primaryGrey">
      <div className="hidden sm:grid  grid-cols-6 grid-rows-3 col-auto gap-4 mx-5 py-5 md:mx-16 2xl:max-w-screen-2xl h-[800px]">
        <div className="row-span-2 lg:row-span-3 col-span-4 lg:col-span-3 ">
          <Image alt="" src={"/assets/home/gallery_img_1.avif"} width={500} height={500} className="w-full h-full" objectFit="cover"/>
        </div>
        <div className="col-span-2 lg:col-span-1 ">
          <Image alt="" src={"/assets/home/gallery_img_2.avif"} width={500} height={500}  className="w-full h-full" objectFit="cover" />
        </div>
        ...
        <div className="col-span-2 bg-red-500"> 5</div>
        <div className="col-span-2 lg:col-span-1 bg-red-600"> 6</div>
      </div>
